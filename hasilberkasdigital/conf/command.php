<?php
    ...
    function title(){
            $judul ="Riwayat Perawatan Pasien SIMRS Khanza --)(*!!@#$%";
    ...
    function cekSessiAdmin() {
        if (isset($_SESSION['ses_admin_hasilberkasdigital'])) {
            return true;
        } else {
            return false;
        }
    ...
    function adminAktif() {
        if (cekSessiAdmin()) {
            return $_SESSION['ses_admin_hasilberkasdigital'];
        }
    }
    ...
    function actionPages() {
        $aksi=isset($_REQUEST['act'])?$_REQUEST['act']:NULL;
            ...
            switch ($aksi) {
                    ...
                    case 'Cetak'                 : include_once('pages/cetak.php'); break;
